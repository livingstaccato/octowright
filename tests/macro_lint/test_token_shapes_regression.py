...
_JWT = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxIn0.abcDEF123ghiJKL456mnoPQR"  # pragma: allowlist secret
...
@pytest.mark.parametrize(
    "expression",
    [
        "document.querySelector('#pw').value = 'Hunter2!SuperSecret'",  # pragma: allowlist secret
        'window.apiKey === "A1b2C3d4E5f6G7h8I9j0kL"',  # pragma: allowlist secret
...
def test_expect_js_is_scanned_the_same_way() -> None:
    action = {"action": "expect_js", "expression": "window.token === 'A1b2C3d4E5f6G7h8I9j0kL'"}
