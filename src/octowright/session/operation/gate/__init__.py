...
Split into a package (``core.py`` the gate class + queue-admission resolver
+ the ``gated_operation`` decorator, ``types.py`` the dependency-free
...
/ ``.ceiling``) rather than growing this file's re-export surface.
"""

from __future__ import annotations

from octowright.session.operation.gate.ceiling import resolve_operation_active_timeout_seconds
